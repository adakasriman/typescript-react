...
// type y = x & { // y type have both x type and y type keys
//     c: number;
//     d: string;
// }
...
// interface Y extends X { // y interface have both X type and Y interface keys
//     c: number;
//     d: string;
// }

// // we can combine both interface and type using above patterns
